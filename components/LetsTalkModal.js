...
import styles from '../styles/LetsTalkModal.module.css'

export default function LetsTalkModal({ open, setOpen, hidden }) {
  ...
  return (
    <div
      ref={ref}
      className={`${styles.wrapper} ${animate ? styles.active : ''} ${hidden ? styles.hidden : ''}`}
      onMouseDown={(e) => {
